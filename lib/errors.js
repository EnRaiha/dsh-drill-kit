...
const EXTERNAL_MARKERS = ['/rustc/', '/rustlib/', '/library/core/', '/library/std/', '/.cargo/registry/', '/node_modules/', '/usr/lib/', '/usr/local/lib/', '/site-packages/', '/.rustup/']
...
export function normalizeFramePath(raw) {
  ...
  const external = EXTERNAL_MARKERS.some(marker => file.includes(marker))
